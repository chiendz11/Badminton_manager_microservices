...
const sellItemSchema = new mongoose.Schema({
  inventoryId: { type: mongoose.Schema.Types.ObjectId, required: true }, // Tham chiếu đến sản phẩm
...
const sellHistorySchema = new mongoose.Schema({
  ...
  centerId: { type: mongoose.Schema.Types.ObjectId, required: true }, // Trung tâm thực hiện giao dịch
